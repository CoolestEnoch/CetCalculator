...
//				a.finish();
	...
	public static MaterialCardView createCardView(Context context, int bg_color_id, String icon_url, List<String> strList) {
		...
		cardParams.setMargins(ViewUtils_java.dp2px(context, 18), ViewUtils_java.dp2px(context, 10), ViewUtils_java.dp2px(context, 18), 0);
		...
		mainCard.setShapeAppearanceModel(mainCard.getShapeAppearanceModel()
				.toBuilder()
				.setBottomLeftCorner(CornerFamily.ROUNDED, (float) ViewUtils_java.dp2px(context, 10))
				.setBottomRightCorner(CornerFamily.ROUNDED, (float) ViewUtils_java.dp2px(context, 10))
				.setTopLeftCorner(CornerFamily.ROUNDED, (float) ViewUtils_java.dp2px(context, 10))
				.setTopRightCorner(CornerFamily.ROUNDED, (float) ViewUtils_java.dp2px(context, 10))
				.build()
		);
		...
		LinearLayout.LayoutParams iconParams = new LinearLayout.LayoutParams(ViewUtils_java.dp2px(context, 28), ViewUtils_java.dp2px(context, 28));
		iconParams.gravity = Gravity.CENTER_VERTICAL;
		iconParams.setMargins(ViewUtils_java.dp2px(context, 26), 0, ViewUtils_java.dp2px(context, 20), 0);//卡片图标左右边距
		...
		infoLinearLayout.setPadding(0, ViewUtils_java.dp2px(context, 25), 0, ViewUtils_java.dp2px(context, 25));
		...
		for (String str : strList) {
			...
			if (firstEle) {//实现第一个文本框加粗
				...
				tv.setPadding(0, 0, 0, ViewUtils_java.dp2px(context, 5));
			} else {
